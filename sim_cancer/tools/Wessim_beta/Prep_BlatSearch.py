...
def main(argv):
	...
	group2.add_argument('-p', metavar = 'INT', dest = 'port', required=False, help = 'Port for blat server', default="6666")
	...
	serverStopCommand = "gfServer stop localhost " + port
	serverStartCommand = "gfServer start -canStop localhost " + port + " " + ref
	blatCommand = "gfClient localhost " + port + " / -minIdentity=" + MINIDENTITY + " -minScore=" + MINSCORE + " " + probefile + " " + outfile
