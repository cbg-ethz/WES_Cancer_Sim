...
if( !file.exists(pdfToPlot)){
		...
		boxplot(auPRCvalues[[1]],auPRCvalues[[2]],auPRCvalues[[3]],auPRCvalues[[4]],auPRCvalues[[5]],auPRCvalues[[6]],auPRCvalues[[7]],auPRCvalues[[8]],col=colors[c(1,5,4,2,6,3,7,8)],names=c("deepSNV", "GATK HP", "GATK UG", "JointSNVMix2", "MuTect", "SAMtools", "SomaticSniper", "Varscan2"), ylab=paste("Area under Precision Recall Curve with ",fdr,"% FDR",sep=""),ylim=c(0,ylimMax),cex.lab=2.5,cex.axis=2.5,las=2)
}
